      ...
      >
        ...
        <ProFormSelect name={'userGender'} label={'性别'} valueEnum={userGender}>
          <Select>
            ...
            <Select.Option value={UserGenderEnum.FEMALE}>{userGender[UserGenderEnum.FEMALE].text}</Select.Option>
            <Select.Option value={UserGenderEnum.SECURITY}>{userGender[UserGenderEnum.SECURITY].text}</Select.Option>
          </Select>
        </ProFormSelect>
