...
/** downloadUserExample GET /api/user/download/example */
export async function downloadUserExampleUsingGet(options?: { [key: string]: any }) {
  return request<any>('/api/user/download/example', {
    method: 'GET',
    ...(options || {}),
  });
}
...
/** importUserDataByExcel POST /api/user/import */
export async function importUserDataByExcelUsingPost(
  ...
  return request<API.BaseResponseMapStringObject_>('/api/user/import', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
